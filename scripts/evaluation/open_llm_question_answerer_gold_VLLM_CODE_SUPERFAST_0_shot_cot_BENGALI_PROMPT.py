...
উত্তর দেওয়ার আগে ধাপে ধাপে ভাবুন (সংক্ষিপ্ত ও নির্ভুলভাবে)। বিশ্লেষণ শেষ হলে শেষ লাইনে ঠিক একটি JSON অবজেক্ট লিখুন: {{"উত্তর":"A"}} যেখানে A/B/C/D হবে আপনার পছন্দ। অন্য কিছু লিখবেন না:
""",
...
উত্তর দেওয়ার আগে ধাপে ধাপে ভাবুন (সংক্ষিপ্তভাবে)। তারপর শেষ লাইনে ঠিক একটি JSON অবজেক্ট লিখুন: {{"উত্তর":"A"}} যেখানে শুধু A/B/C/D থাকবে:
""",
            
            # Variation 3: Direct compact CoT + JSON
            f"""{question}
A) {options[0]} B) {options[1]} C) {options[2]} D) {options[3]}
উত্তর দেওয়ার আগে ধাপে ধাপে ভাবুন (সংক্ষিপ্তভাবে)। শেষে শেষ লাইনে ঠিক একটি JSON অবজেক্ট লিখুন: {{"উত্তর":"A"}}। শুধু A/B/C/D থাকবে, অন্য কিছু নয়:
""",
...
C) {options[2]}
D) {options[3]}
উত্তর দেওয়ার আগে অবশ্যই ধাপে ধাপে ভাবুন (সংক্ষিপ্তভাবে)। শেষে শেষ লাইনে শুধু একটি JSON অবজেক্ট লিখুন: {{"উত্তর":"A"}} যেখানে A/B/C/D হবে; অন্য কিছু নয়:
""",
            
            # Variation 5: Minimal CoT + JSON
            f"""{question}
A){options[0]} B){options[1]} C){options[2]} D){options[3]}
উত্তর দেওয়ার আগে ধাপে ধাপে ভাবুন (সংক্ষিপ্তভাবে)। তারপর শেষ লাইনে ঠিক একটি JSON অবজেক্ট লিখুন: {{"উত্তর":"A"}} (A/B/C/D)। অন্য কিছু নয়:
"""
        ]
    ...
    def build_cot_json_prompt(self, question, options):
        """Build the primary zero-shot CoT + JSON instruction prompt for batching."""
        if len(options) < 4:
        ...
        return (
            ...
            f"C) {options[2]}\n"
            f"D) {options[3]}\n\n"
            f"উত্তর দেওয়ার আগে ধাপে ধাপে ভাবুন (সংক্ষিপ্ত ও নির্ভুলভাবে)। বিশ্লেষণ শেষ হলে শেষ লাইনে ঠিক একটি JSON অবজেক্ট লিখুন: {{\"উত্তর\":\"A\"}} যেখানে A/B/C/D হবে আপনার পছন্দ। অন্য কিছু লিখবেন না:\n"
        )
